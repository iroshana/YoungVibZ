<%-- 
    Document   : signup
    Created on : Feb 19, 2016, 7:08:24 PM
    Author     : Ravindu
--%>
...
<html class="hide-sidebar ls-bottom-footer" lang="en">
    <head>
        ...
        <title>Sign Up Young VibZ</title>
        ...
        <script language="javascript" type="text/javascript">
            function validation() {
                if(document.getElementById("FirstName").value === null){
                    ...
                    return;
                }else if(document.getElementById("Password").value === "" && document.getElementById("ConfirmPass") === ""){
                    alert("Please Enter the Password");
                    return;
                }else if (document.getElementById("Password").value !== document.getElementById("ConfirmPass")){
                    //alert("Password and Confirm Passwor is not Matched");
                    //return;                    
                }else {
                }
            }
            ...
            <div class="container-fluid">
                ...
                <div class="lock-container">
                    ...
                    <div class="panel panel-default text-center">
                        <img src="images/signup.jpg" class="img-circle">
                        <div class="panel-body">
                            <form name="signup" action="pagedetailset.jsp" method="post">
