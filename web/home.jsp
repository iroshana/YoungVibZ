<%-- 
    Document   : home
    Created on : Feb 20, 2016, 11:12:18 AM
    Author     : Ravindu
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html class="st-laclassyout ls-top-navbar ls-bottom-footer show-sidebar sidebar-l2" lang="en">
    <head>
    ...
    <body>
        <div class="st-container">
            ...
            <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">Young VibZ</a>
                    </div>
                ...
                <div data-scrollable>
                    <div class="sidebar-block">
                        <div class="profile">
                            ...
                            <h4><input type="hidden" name="Uname" value=""></h4>
                        </div>
                    </div>
            ...
            <!-- Footer -->
            <footer class="footer">
                <strong>Young VibZ</strong> v1.0.0 &copy; Copyright 2016
            </footer>
            <!-- // Footer -->
